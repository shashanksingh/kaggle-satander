...
print "[Clustering][Step 1] Find out unique customers"
print "[Clustering] Load CSV"
...
# print "[Clustering] Customer Code ", unique_customer_codes
print "[Clustering] Unique customer count", unique_customer_codes.count()

print "[Clustering][Step 2] How many times have they bough a certain product"
...
print "[Clustering] Groupby customer code"
customer_with_product_array_grouped_by_customer = customer_with_product_array.groupby(["ncodpers"])
print "[Clustering] Stats - Groupby customer code"
product_array_sum = customer_with_product_array_grouped_by_customer.aggregate(np.sum)
# customer_with_product_array.duplicated()

print "[Clustering][Step 3] Find out similar customers ( clustering -> age and other features )"
